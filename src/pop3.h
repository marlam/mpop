...
#define POP3_CAP_CAPA                   (1 << 11)
#define POP3_CAP_TOP                    (1 << 12)
#define POP3_CAP_LOGIN_DELAY            (1 << 13)
#define POP3_CAP_PIPELINING             (1 << 14)
#define POP3_CAP_EXPIRE                 (1 << 15)
#define POP3_CAP_UIDL                   (1 << 16)
#define POP3_CAP_IMPLEMENTATION         (1 << 17)
#define POP3_CAP_STLS                   (1 << 18)
#define POP3_CAP_RESP_CODES             (1 << 19)
#define POP3_CAP_AUTH_RESP_CODE         (1 << 20)
